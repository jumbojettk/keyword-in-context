...
// Name: Header File for Binary Search Tree - binarySearchTree.h
// Description: This is the header file for binarySearchTree class that 
//				contains the function definition, implementation, and
//				documentation for the binarySearchTree class.
//******************************************************************************
                 ...
                 (const elemType& insertItem)
{
    ...
    nodeType<elemType> *newNode = NULL;      //pointer to create the node
    ...
    else
    {
        ...
        while (current != NULL)
        {
			...
			// Modify to allow duplicate key inserted to the right subtree
                                 ...
                                 (nodeType<elemType>* &p)
{
    nodeType<elemType> *current = NULL;       //pointer to traverse the tree
    nodeType<elemType> *trailCurrent = NULL;  //pointer behind current
    nodeType<elemType> *temp = NULL;          //pointer to delete the node
